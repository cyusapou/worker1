    ...
    <div class="history-view__content">
      ...
      <div v-else class="payments-grid">
        <PaymentEvidenceModal
          ...
          :reference-code="(payment as any).referenceCode || (payment as any).reference"
          :method="(payment as any).method || 'Bank Transfer'"
          :phone="(payment as any).phone || '+250788000000'"
          :customer-name="(payment as any).customerName || 'You'"
          :house-location="(payment as any).houseLocation || 'Unknown'"
