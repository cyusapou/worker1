            ...
            <template v-else>
              ...
              <div class="details-grid">
                ...
                <div class="detail-item">
                  ...
                  <span class="detail-value">{{ house.email || 'N/A' }}</span>
                </div>
                <div class="detail-item">
...
const fetchHouses = async () => {
  ...
  try {
    ...
    if (response.ok) {
      ...
      houses.value = data.map((h: any) => ({
        ...h,
        fullName: h.name || `${h.firstName} ${h.lastName}` || 'No Name',
        paid: false, // We'll link this to actual collection records later
